...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        Product result = supplier.getProductCatalog().searchProduct(Integer.parseInt(idField.getText()));            
        if(result == null) {
            JOptionPane.showMessageDialog(null, "Product ID you entered does not exist", "Information", JOptionPane.INFORMATION_MESSAGE); 
        }
        else {
        ManageProductCatalogJPanel mpcjp = new ManageProductCatalogJPanel(workArea, result,supplier);
